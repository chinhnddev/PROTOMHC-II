...
from sklearn.metrics import average_precision_score  # <-- THÊM DÒNG NÀY (quan trọng nhất)
...
class ProtoMHCII(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(
            ...
            mode="max",
            factor=0.5,
            patience=3,        # <-- tăng từ 2 → 3 để ổn định hơn
            verbose=True
        )
        return {
            "optimizer": optimizer,
